        ...
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                Button {
                    ...
                    guard let url = URL(string: "https://splt.money/clip?code=\(joinCode)") else { return }
                    openURL(url)
                } label: {
                    Text("Open in SPLT")
                        .font(.headline)
                ...
                Text("If the full app does not open, install SPLT and enter the code in Join.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
...
#Preview {
    ContentView(invocationURL: URL(string: "https://splt.money/clip?code=123456"))
}
